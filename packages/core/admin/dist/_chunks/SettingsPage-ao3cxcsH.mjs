...
import { y as SETTINGS_LINKS_CE, p as useEnterprise, u as useConfiguration, d as createRoute } from "./index-c1neTvdI.mjs";
import sortBy from "lodash/sortBy";
import { useSelector } from "react-redux";
import { s as selectAdminPermissions } from "./AuthenticatedApp-2u5HUcNG.mjs";
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import("./constants-B5na-9TL.mjs")).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-XjcIYZbi.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-vm6yAjqK.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-32_WzRG5.mjs");
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-nTYYOVmf.mjs");
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-_HnX0IHs.mjs");
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-zJOOQhDM.mjs");
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-UrcIvjUR.mjs").then((n) => n.b);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-iMaec0pb.mjs");
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-KpN32451.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-TkEOTrFC.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditViewPage-p6Dhe4HM.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-lfnBeVNo.mjs");
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-XiJRqyD5.mjs");
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditView-mmuWvJ3S.mjs");
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import("./AdminSeatInfo-d7dDccEz.mjs")).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-sttb29UP.mjs")).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-ao3cxcsH.mjs.map
