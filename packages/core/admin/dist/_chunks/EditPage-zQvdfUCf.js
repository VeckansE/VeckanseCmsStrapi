...
const useWebhooks = require("./useWebhooks-glAj-Khx.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-4NFJAO-J.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-zQvdfUCf.js.map
