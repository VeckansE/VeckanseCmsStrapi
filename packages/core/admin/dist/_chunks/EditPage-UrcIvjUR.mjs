...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-c1neTvdI.mjs";
...
import { u as useWebhooks } from "./useWebhooks-iW9Grc_D.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-9-DfVnQL.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-UrcIvjUR.mjs.map
